            ...
            <div class="panels">
                <div class="panel">
                    <div style="display:flex;align-items:center;justify-content:space-between">
                        ...
                        <a href="{{ route('admin.users') }}" class="btn" style="background:#fff;color:#7A0200;border:1px solid rgba(122,2,0,0.08);">Manage users</a>
                    </div>
                    <ul class="user-list">
                        @foreach($users as $user)
                            <li class="user-item">
                                ...
                                @if(!empty($dbAvailable) && $dbAvailable)
                                    <a href="{{ route('admin.tugas', ['user' => $user->id]) }}" class="btn">Tugas</a>
                                @else
    ...
    <script>
        (function(){
            ...
            document.addEventListener('click', function(e){
                ...
                if (!sidebar.contains(e.target) && !Array.from(toggles).some(t=>t.contains(e.target)) && !fixedToggle.contains(e.target)) {
